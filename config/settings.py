...
ALLOWED_HOSTS = ['*'] # Required for Vercel dynamic domains

# --- DATABASE ---
# Priority 1: Environment Variable (Neon/Vercel)
...
# Robust WhiteNoise Configuration for Vercel
